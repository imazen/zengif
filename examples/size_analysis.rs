...
fn main() {
    ...
    for entry in &entries {
        ...
        let sizes: Vec<_> = thresholds.iter()
        ...
        println!("{:<40} {:>6}K {:>6}K {:>6}K {:>6}K {:>6}K {:>6}K{}", 
            &name[..name.len().min(40)], 
            orig_size/1024, sizes[0]/1024, sizes[1]/1024, sizes[2]/1024, sizes[3]/1024, sizes[4]/1024,
            marker);
    }
}
